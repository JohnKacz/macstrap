...
# TODO - Need to keep going if you hit an error (i.e. FK_StandardViewSettings:IconViewSettings)
...
echo -e "\t- Hiding the Time Machine, Volume, User, and Bluetooth icons"
...
echo -e "\t- Disabling press-and-hold for special keys in favor of a key repeat"
...
echo -e "\t- Show icons for hard drives, servers, and removable media on the desktop"
...
echo -e "\t- Increasing grid spacing for icons on the desktop and in other icon views"
...
echo -e "\t- Increasing the size of icons on the desktop and in other icon views"
...
echo -e "\t- Wiping all (default) app icons from the Dock"
...
echo -e "\t- Disable the sudden motion sensor? (Not useful for SSDs) (y/n)"
read -r response
